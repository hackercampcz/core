...
// AWS_PROFILE=topmonks deno run --allow-env --allow-net --allow-read=$HOME/.aws/credentials,$HOME/.aws/config send-feedback-mails.js --token $(op read 'op://Hacker Camp/Postmark/credential')
