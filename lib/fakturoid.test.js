...
describe("fetchInvoice", () => {
  ...
  it("throws on a non-ok response", async () => {
    vi.stubGlobal("fetch", mockFetch({ error: "not_found", error_description: "Invoice not found" }, { ok: false, status: 404 }));
...
describe("createSubject", () => {
  ...
  it("throws on error response", async () => {
    vi.stubGlobal("fetch", mockFetch({ error: "duplicate", error_description: "Already exists" }, { ok: false, status: 422 }));
