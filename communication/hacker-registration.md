...
Mezi tím se ujisti, že máš [vyplněné fakturační údaje](https://donut.hckr.camp/registrace) (alespoň adresu, bez té Ti
fakturu nevystavíme). Se zaplacením faktury Ti přijde potvrzení na Slack a otevře se ti možnost vybrat si
...
Je čas si ho znovu aktivovat, připnout nahoru a občas zkouknout, aby ti neuniklo nic podstatného.

Kromě sledování aktuálního dění, informací a řešení otázek,
co tě můžou napadnout, totiž Slack slouží jako tvůj identifikátor a vstupenka.
...
Ubytko si hlídá `@Pavla Verflová`. Pokud týden před kempem nebudeš mít booklou svoji postel,
